...
##  Main script to perform cutting procedure on too large patches - assessing initial patches, 
## finding in how many patches to cut, cutting patches, creating the final patch layer  
##
############################################################################################
############################################################################################
